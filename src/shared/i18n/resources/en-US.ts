  ...
  translation: {
    ...
    chat: {
      permissionMode: {
        ...
        readRequired: "A supported, current server state is required before changing permissions.",
        help: {
          default: "Default: follow the configured permission policy and ask when required.",
          bypass: "Bypass: skip ordinary approvals; forced confirmations still ask. Hard denials and sandbox limits still apply.",
          auto: "Auto: no approval prompts, including forced confirmations. Hard denials, Plan/Guardian read-only rules, authentication and OS/sandbox limits still apply.",
        },
        confirmTitle: "Enable Auto for this session?",
        confirmDescription: "In “{{title}}”, Auto allows tools to run without any approval prompt, including risky operations and forced-confirmation rules. Hard denials, Plan/Guardian read-only rules, authentication and OS/sandbox limits remain in force. This changes only this session.",
        confirm: "Enable Auto",
        cancel: "Cancel",
        errors: {
          conflict: "The session changed elsewhere. The refreshed server mode is shown; choose again if you still want to change it.",
          rejected: "The change was rejected. The refreshed server mode is shown; no write was retried.",
    ...
    settings: {
      ...
      jiandu: {
        ...
        description:
          "Memory is shared by sessions in the current project. Auto Dream remains a separate system setting.",
        context: {
          label: "Current Project context",
          loading: "Validating the current session and project…",
          session: "Current session",
          project: "Project ID",
          rootSession: "Authority root session",
          retry: "Validate again",
        },
        errors: {
          invalid: "The input is incomplete or exceeds an allowed length or count.",
          context: "The current session has no usable project. Select a regular project-bound session.",
          denied: "You do not have permission to access memory for this project.",
          unavailable: "The memory service is temporarily unavailable. Try again later.",
          rejected: "This session cannot access memory. Select a regular project-bound session.",
          malformed: "The memory service returned unverifiable data, so the result was not trusted.",
        },
        types: {
          user: "User",
          feedback: "Feedback",
        ...
        search: {
          ...
          placeholder: "Leave blank to browse all project memory",
          action: "Search",
          refresh: "Refresh",
        },
        list: {
          label: "Project memory list",
          count: "Showing {{visible}} of {{matched}}",
          truncated: "Results are truncated",
          remaining: "{{count}} more",
          empty: "No matching project memory",
          loading: "Loading project memory…",
          more: "Load more",
        },
        detail: {
          title: "Memory detail",
          loading: "Loading the selected memory…",
          bodyTruncated: "The body is shown only up to the safe display limit.",
          metadataTruncated: "Some retrieval metadata was truncated.",
          close: "Close details",
        },
        create: {
          open: "New memory",
          title: "New project memory",
          description: "Look for related memory before creating. Nothing is merged automatically.",
          ...
          granularityLabel: "Time granularity",
          noGranularity: "None",
          csvHint: "Separate values with commas",
          lookup: "Find similar memory",
          lookingUp: "Looking…",
          matchesLabel: "Pre-create duplicate check",
          matches: "Possibly related memory",
          noMatches: "No similar memory found",
          matchesTruncated: "Similar results were truncated at the safe limit.",
          confirm: "Create explicitly",
          creating: "Creating…",
          close: "Close new memory",
        },
        archive: {
          open: "Archive memory",
          title: "Archive “{{title}}”?",
          description: "This archives only this record. It is not permanently deleted and no other memory is affected.",
          cancel: "Cancel archive",
          confirm: "Confirm archive",
          archiving: "Archiving…",
        },
        notices: {
          created: "Created “{{title}}” and refreshed the list from project authority.",
          archived: "Archived “{{title}}” and refreshed the list from project authority.",
          createdRefreshFailed: "Created “{{title}}”, but the list refresh failed. Refresh it manually.",
          archivedRefreshFailed: "Archived “{{title}}”, but the list refresh failed. Refresh it manually.",
        },
      },
      notifications: {
