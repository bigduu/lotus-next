  ...
  translation: {
    ...
    chat: {
      permissionMode: {
        ...
        unconfirmed: "状态未确认",
        refresh: "刷新权限模式",
        readRequired: "确认后端支持且读取到当前状态后，才能更改权限模式。",
        help: {
          default: "Default：遵循已配置的权限策略，在需要时请求批准。",
          bypass: "Bypass：跳过普通审批，强制确认仍会询问；明确禁止规则和沙箱限制仍然生效。",
          auto: "Auto：不弹出任何审批，包括强制确认。明确禁止规则、Plan/Guardian 只读边界、认证和操作系统／沙箱限制仍然生效。",
        },
        confirmTitle: "为当前会话启用 Auto？",
        confirmDescription: "在「{{title}}」中，Auto 允许工具运行时不再请求任何批准，包括高风险操作和强制确认规则。明确禁止规则、Plan/Guardian 只读边界、认证和操作系统／沙箱限制仍然生效。此设置仅影响当前会话。",
        confirm: "启用 Auto",
        cancel: "取消",
        errors: {
          conflict: "会话已在其他位置更改。现已显示后端最新模式；如仍需更改，请重新选择。",
          rejected: "更改被拒绝。现已显示后端最新模式，未重发写入请求。",
    ...
    settings: {
      ...
      jiandu: {
        title: "项目记忆",
        description: "当前项目的记忆在同一项目的会话间共享。Auto Dream 配置仍在系统设置中独立管理。",
        context: {
          label: "当前 Project 上下文",
          loading: "正在验证当前会话与项目…",
          session: "当前会话",
          project: "项目标识",
          rootSession: "授权根会话",
        ...
        errors: {
          invalid: "输入不完整或超出允许的长度与数量限制。",
          context: "当前会话未绑定可用项目。请选择普通且已绑定项目的会话。",
          denied: "没有访问当前项目记忆的权限。",
          unavailable: "暂时无法访问记忆服务，请稍后重试。",
          rejected: "该会话不能访问记忆。请选择普通且已绑定项目的会话。",
          malformed: "记忆服务返回了无法验证的数据，本次结果未被采信。",
        },
        types: {
          user: "用户",
          feedback: "反馈",
        ...
        search: {
          label: "搜索项目记忆",
          statusLabel: "记忆状态",
          placeholder: "留空可浏览全部项目记忆",
          action: "搜索",
          refresh: "刷新",
        },
        list: {
          label: "项目记忆列表",
          count: "已显示 {{visible}} / {{matched}} 条",
          truncated: "结果已截断",
          remaining: "另有 {{count}} 条",
          empty: "没有匹配的项目记忆",
          loading: "正在加载项目记忆…",
          more: "加载更多",
        },
        detail: {
          title: "记忆详情",
          loading: "正在读取所选记忆…",
          bodyTruncated: "正文只显示了安全上限内的内容。",
          metadataTruncated: "部分检索元数据已被截断。",
          close: "关闭详情",
        },
        create: {
          open: "新建记忆",
          title: "新建项目记忆",
          description: "创建前必须先查找可能相关的记忆；系统不会自动合并。",
          titleLabel: "记忆标题",
          typeLabel: "记忆类型",
          bodyLabel: "记忆正文",
          tagsLabel: "标签（逗号分隔）",
          keywordsLabel: "关键词（逗号分隔）",
          entitiesLabel: "实体（逗号分隔）",
          granularityLabel: "时间粒度",
          noGranularity: "不设置",
          csvHint: "用英文逗号分隔",
          lookup: "查找相似记忆",
          lookingUp: "正在查找…",
          matchesLabel: "创建前查重结果",
          matches: "可能相关的记忆",
          noMatches: "未找到相似记忆",
          matchesTruncated: "相似结果已按安全上限截断。",
          confirm: "明确创建",
          creating: "正在创建…",
          close: "关闭新建",
        },
        archive: {
          open: "归档记忆",
          title: "归档“{{title}}”？",
          description: "此操作只归档这一条记录，不会永久删除，也不会影响其他记忆。",
          cancel: "取消归档",
          confirm: "确认归档",
          archiving: "正在归档…",
        },
        notices: {
          created: "已创建“{{title}}”，并从项目权威数据刷新列表。",
          archived: "已归档“{{title}}”，并从项目权威数据刷新列表。",
          createdRefreshFailed: "已创建“{{title}}”，但列表刷新失败；请手动刷新。",
          archivedRefreshFailed: "已归档“{{title}}”，但列表刷新失败；请手动刷新。",
        },
      },
      notifications: {
